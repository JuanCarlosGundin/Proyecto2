...
<body id="portada">
    <div class="row2" id="section-1">
        ...
        <b><a class="btn-logout">Añadir</a></b>
        </ul>
        </div>
        ...
        <div class="logout column-1">
            <ul class="padding-lat">
            <b><a style="text-decoration:none" class="btn-logout" href="usuarios.admin.php">Volver</a></b>
            </ul>
        </div>
    </div>
    <div class="flex">
        <div class="menu">
    <h1 <?php echo "style='color: black;'";?> >Crear usuario</div> 
    </div>
        ...
        <form METHOD='POST' action='../processes/crear.user.proc.php' onsubmit="return inscripcion()">
            ...
            <td><input type='text'  name='contra' id='contra'></td>
                <td><select name="perfil">
                    ...
                    <option value="2" selected >Camarero</option>
                </select></td>
